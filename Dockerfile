...
RUN /root/anaconda3/envs/ldm/bin/pip install -e git+https://github.com/CompVis/taming-transformers.git@master#egg=taming-transformers
RUN /root/anaconda3/envs/ldm/bin/pip install -e git+https://github.com/openai/CLIP.git@main#egg=clip
...
RUN /root/anaconda3/envs/ldm/bin/pip install pydantic
RUN /root/anaconda3/envs/ldm/bin/pip install pydantic[dotenv]
